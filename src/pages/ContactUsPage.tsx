  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="py-10 text-center text-white">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto pb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 h-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                disabled={loading}
                type="submit"
                className="w-full bg-[#2563EB] text-white py-3 rounded-lg font-medium hover:bg-blue-800 transition-colors"
              >
          ...
          <div className="space-y-8 mt-12 lg:mt-0">
              ...
              <ul className="space-y-6">
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Office No. 18, Nice Sankul, Near ITI Signal, Trambak Road, Satpur, Nashik 422010
                    </p>
                  </div>
                </li>
                <li className="flex items-center gap-4">
                  ...
                  <p className="text-gray-600 text-lg">
                    <a href="tel:+919529044429"> +91 9529044429 </a>
                  </p>
                </li>
                <li className="flex items-center gap-4">
                  <div className="bg-blue-100 p-3 rounded-full text-blue-700">
                  ...
                  <p className="text-gray-600 text-lg">
                    <a href="mailto:contact@simplesphere.in">
            ...
            <div className="rounded-2xl overflow-hidden h-64 border border-gray-200 shadow-sm relative bg-gray-200">
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1582.3164459498794!2d75.55424453122475!3d21.00842618031778!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4694999dcbdd588d%3A0x432bb19a66d10704!2sSimplesphere%20Technologies!5e1!3m2!1sen!2sin!4v1776240821646!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
