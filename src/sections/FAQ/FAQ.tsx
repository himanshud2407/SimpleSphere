    ...
    <section className="py-20 bg-gray-50/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div
            id="contact-form"
            className="bg-white p-8 rounded-3xl border border-gray-100 shadow-xl shadow-blue-500/5"
          >
            ...
            {status && (
              <div
                className={`p-4 rounded-xl mb-6 text-sm font-medium ${status.type === "success" ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"}`}
              >
                {status.msg}
              </div>
            )}
